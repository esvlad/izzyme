...
class PointsController extends Controller
{
    ...
    {
      return view('partners.points.index', [
    ...
    {
        return view('partners.points.create', [
          'company' => Point::getCompany()
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('partners.points.index');
    }
    ...
    {
        return view('partners.points.show', [
          'point' => $point
        ]);
    }
    ...
    {
        return view('partners.points.edit', [
          'point' => $point,
          'company_id' => Point::getCompany()
        ]);
    }
